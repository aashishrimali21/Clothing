...
<?php
		...
		if(isset($_GET['sub']))
		{
			$count=0;
			$name=$_GET['sub'];
			$q = "select * from product where subcategory_name='$name' and category_name='men'";
...
?>
			...
			<div class="col-sm-4" style="text-align: center;padding-top: 10px; ">
				<div class="display">
					<a href="menassdetail.php?aid=<?php echo $row['product_id']; ?>">
					...
					Quantity:<input type="number" id="quantity" value="1" min="1" max="10" name="quantity" style="width:33px;margin-right:20px;"/> 
					<br><br>
					<div><button type="submit" class="btn btn-info">Add to Cart</button></div>
