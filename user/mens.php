...
<div class="container" style="background-color: white">
    ...
    <div class="container col-sm-4">
        ...
        <div class="container col-sm-8">
                                    ...
                                    <h1 style="margin-top: 10px;font-size: 50px">&nbsp <?php echo $row['product_name'];?></h1><br>
                       ...
                       <div class="row">
                                <div class="col-sm-3"><h2>&nbsp &nbsp Discription :</h2></div>
                    ...
                    <select id="size" name="size" style="margin-left: 15px">
                        <option>S</option>
                        <option>M</option>
                        <option>L</option>
                        <option>XL</option>
